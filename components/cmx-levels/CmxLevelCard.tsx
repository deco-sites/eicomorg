...
function CmxLevelCard (
  ...
  return (
    <a href={href} class="lg:w-[340px] md:w-[524px] xs:w-[385px] md:block xs:block md:m-auto xs:m-auto md:mb-[20px] xs:mb-[20px] bg-[#fff] shadow-[1px_1px_10px_rgba(0,0,0,.2)] hover:shadow-[1px_1px_10px_rgba(0,0,0,.3)] rounded-tr-[41px]">
        <header
                ...
                {topics.map(topic =>
                    <div class="flex py-[10px]">
                        ...
                        <div class="inline-block">
                            ...
                            { topic.subtitle ? <span class="block text-[#808080] [&>*]:text-[#808080] text-[14px] [&>*]:text-[14px]" dangerouslySetInnerHTML={{ __html: topic.subtitle }}></span> : <></> } 
                        </div>
                    </div>
                )}
            </div>
