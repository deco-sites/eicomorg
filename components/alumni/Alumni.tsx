...
function AlumniCard(
    ...
    return (
        <div class={`border border-solid bg-white border-[#dfdfdf] w-full mx-auto pt-[20px] px-[30px] pb-[10px] relative ${gridPositions[index]} xs:col-span-3 xs:w-[97%]`}>
            <div class="items-center flex justify-start">
                ...
                />
                <img class="w-[50px] h-[50px] rounded-[40px] border-solid border-[3px] border-[#dfdfdf]" src={avatar.src} alt={avatar.alt} />
                <div class="font-Gravity text-[#696969] pl-[20px] py-[10px]">
                    <span class="block text-[14px] leading-[22px] uppercase font-bold">{ name }</span>
            ...
            <div class="text-[#262628] border-t-[1px] border-solid border-t-[#dfdfdf] mt-[10px] pt-[30px] pb-[10px]">
                <span class="[&>*]:text-[#262628] [&>*]:font-normal [&>*]:font-Gravity [&>*]:leading-[1.6rem] " dangerouslySetInnerHTML={{ __html: text }}></span>
            </div>
        </div>
    )
}
      ...
      <div class="bg-[#f3f3f3] py-[100px]">
        <div class="max-w-[700px] m-auto">
          ...
          <p class="text-[16px] mb-3">
            <span class="[&>*]:font-Gravity" dangerouslySetInnerHTML={{ __html: content }}></span>
          </p>
        </div>
