  ...
  return (
    <>
      <div class=" pb-[10px] box-border" onClick={toggleExpand}>
        <div
          className={`text-left cursor-pointer leading-[1.6rem] text-[16px]  relative p-[10px] flex border justify-between border-solid font-Gravity border-gray-300 rounded-md
