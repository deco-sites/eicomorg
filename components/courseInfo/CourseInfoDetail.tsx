  ...
  return (
    <>
      <div class="pb-3 bg-[#262628]">
        ...
        {showDetails && (
          <div class="bg-[#262628] toggle-content border-orange-500 border mt-[-1px] mx-[4px] xs:pt-[10px] xs:pr-[10px] xs:pb-[1px] xs:pl-[20px] md:py-3 md:px-5">
            {label && (
            ...
            <ul class="text-white mt-0 mb-3 xs:pl-5 md:pl-10 list-square">
              {children.map((list) => (
                <li class="text-white py-1 xs:text-[14px] xs:leading-[22px] md:leading-6 md:text-[16px]">
