        ...
        <div class="lg:w-64 lg:h-52 md:h-[335px] md:w-[335px] float-left mx-3 mb-5">
          <div class="cursor-pointer bg-white border border-gray-300 rounded-md ml-0 mr-0 p-0">
            ...
            <div class="h-36 text-left px-4 py-2">
              <h3><span dangerouslySetInnerHTML={{ __html: name }}></span></h3>
              <p><span dangerouslySetInnerHTML={{ __html: position }}></span></p>
            </div>
          </div>
        </div>
      </label>
      ...
      <div className="modal">
        <div className="modal-box max-w-[900px] h-[520px] bg-white rounded-md mx-auto p-5 shadow-md">
          <div className="modal-action">
            <label htmlFor={stringIndex} class='h-4 float-right cursor-pointer'><Icon id="XMark" width={20} height={20} strokeWidth={2} /></label>
          </div>
          ...
          xs:justify-start xs:items-end md:pb-5 lg:pb-0 xs:flex md:flex lg:block xs:mb-5 lg:mb-0'>
            <Image
                ...
                />
            <a href={linkedinURL} class="w-6 h-6 float-right cursor-pointer mt-6 xs:ml-6 lg:ml-0">
          ...
          <div class="pl-7 pr-5 lg:w-3/4 float-left min-h-1 xs:w-full md:w-full md:left-auto md:right-auto relative">
              ...
              <p><span dangerouslySetInnerHTML={{ __html: position }}></span></p>
              <div class="mt-3">
                <p><span dangerouslySetInnerHTML={{ __html: text }}></span></p>
              </div>
          </div>
        </div>
      </div>
