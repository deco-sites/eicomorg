...
function ElevateYourCareer(
    {
        title, subTitle, text, graphic, url
    }: Props,
  ) {
    return (
      <>
        <div class="py-24 bg-gray-100">
            <div class="z-auto max-w-[1120px] pr-0 relative mx-auto">
                ...
                <div class="mx-[-10px] align-center flex xs:flex-col md:flex-row px-2">
                    <div class="xs:w-full md:w-[40%] float-left px-3 mb-3 relative md:">
                        <p class="text-left pb-3 text-2xl mb-3">
                    ...
                    <div class="text-center xs:w-full md:w-[60%] float-left px-3 relative ">
                        <a href={url} class="max-w-full inline-block cursor-pointer" target="blank">
                        <Image
                            src={graphic.src}
                            alt={graphic.alt}
                            width={500}
                            height={375}
                            class="bg-white rounded-md mb-3 ml-2 mr-13 pb-0 shadow-sm max-w-full align-middle inline-block"
                        />
                        </a>
                    </div>
                </div>
