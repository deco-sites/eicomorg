            ...
            <div class="md:w-1/2 xs:w-full left-auto right-auto float-left px-[10px] relative">
							<div
								style={{
									...
									clipPath: "polygon(0% 0%, 100% 0%, 100% 75%, 82% 100%, 0% 100%)"
									}}
									class="lg:block xs:hidden lg:w-[600px] lg:h-[400px]"></div>
							<div
								style={{
									backgroundImage: `url(${image})`,
									backgroundRepeat: "no-repeat",
									...
									class="lg:hidden xs:hidden md:block w-[500px] h-[300px]"></div>
							<div
								style={{
									backgroundImage: `url(${image})`,
									backgroundRepeat: "no-repeat",
									...
									class="md:hidden xs:block w-auto h-[200px]"></div>
							
            </div>
            <div class={`md:w-1/2 xs:w-[98%] left-auto right-auto float-left px-[10px] relative
							`}>
							<div class={`rounded-sm bg-[#fff] md:p-10 xs:pt-5 xs:pl-5 xs:pr-[10px] absolute md:top-[60px] bottom-auto md:left-[-68px]
							shadow-[4px_4px_7px_rgba(38,38,40,0.1)]  ${isShown ? "animate-slide-left" : ""}`}>
