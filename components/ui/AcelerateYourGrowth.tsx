...
function AcelerateYourGrowth(
  ...
  return (
    <>
      <div class="bg-[#f3f3f3] py-[100px] box-border"
        style={{
        ...
        <div class="max-w-[1120px] mx-auto ">
					<div class="mb-0 py-5">
						<h1 class={`md:text-[28px] md:leading-[34px] xs:text-[26px] xs:leading-[32px] my-5 block text-center font-AvenirNextLTPro
								...
								{countries.map((country) => {
									return (
										<div class="pb-[10px] pr-[10px] inline-block">
											<div class="text-[#475769] cursor-pointer bg-[#fff] border-[1px] border-solid rounded-[20px] py-[4px] md:pr-[18px] xs:pr-[10px] pl-[15px] border-[#d9d9e2]"
											style={{transition: "background-color .2s"}}>
												<span dangerouslySetInnerHTML={{__html: country.country}}></span> 
											</div>
										</div>
									)
								})}
