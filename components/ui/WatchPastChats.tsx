          ...
          <div class="block">
            <div role="list" class="">
              {cards.map((card) => {
                return (
                  <div
                    role="listitem"
                    class="w-full text-left bg-[#f3f3f3] border-b-[1px] border-b-[#dfdfdf] border-b-solid rounded-sm flex-col justify-around mr-[16px] pt-[30px] pb-[20px] flex"
                  >
                    <div>
                      <div class="lg:w-1/3 xs:w-full xs:text-center lg:text-left float-left md:pr-[10px] xs:px-0 relative">
                        <a
                          href={card.youtubeURL}
                          class="md:w-[320px] md:h-[180px] xs:w-full xs:h-[200px]   max-w-full inline-block"
                          style={{
                        ...
                        >
                          <div
                            class="md:w-[320px] md:h-[180px] xs:w-full xs:h-[200px] opacity-80 hover:opacity-100 cursor-pointer transition-opacity"
                            style={{
                      ...
                      <div class="lg:pl-0 lg:w-2/3 xs:w-full float-left lg:pr-[10px] relative xs:text-center lg:text-left md:px-5 xs:px-[10px]">
                        ...
                        <div class="items-center py-[10px] flex">
                          <div
                            class="w-[45px] h-[45px] rounded-[40px] border-[2px] border-solid border-[#dfdfdf] mr-[10px]"
                            style={{
                          ...
                          <div class="font-Gravity text-[14px] leading-[20px]">
                            <span
                              dangerouslySetInnerHTML={{ __html: card.person }}
                            >
                            </span>
                          </div>
                        </div>
            ...
            <div role="navigation" class="pt-5 block bg-[#f3f3f3] h-[80px]">
              {!firstPage && (
                <a
                  href={previous.url}
                  class="float-left bg-[#f3f3f3] border-[#f3f3f3] font-Gravity mx-[10px] py-[9px] px-[20px] text-[14px] block cursor-pointer hover:border-[#d9d9e2] hover:border-[1px] hover:border-solid"
                >
                  <div class="max-w-full inline-flex items-center">
                    ...
                    />
                    <span dangerouslySetInnerHTML={{ __html: previous.text }}>
                    </span>
                  </div>
                </a>
              )}
              {!lastPage && (
                <a
                  href={next.url}
                  class="float-right bg-[#f3f3f3] border-[#f3f3f3] font-Gravity mx-[10px] py-[9px] px-[20px] text-[14px] block cursor-pointer static  hover:border-[#d9d9e2] hover:border-solid hover:border-[1px]"
                >
                  <div class="max-w-full inline-flex items-center">
                    <span dangerouslySetInnerHTML={{ __html: next.text }}>
                    </span>
                    <Icon
                      id="ChevronRight"
                      width={12}
