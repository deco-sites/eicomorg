...
function Wiki(
  {
    topText, subjects, pages = [], arrowImage}: Props,
) {
  return (
    <>
      <div class="mt-0 md:pt-[40px] md:pb-[60px] xs:pb-[10px] xs:pt-0 relative box-border md:h-[800px] xs:h-[700px]">
            ...
            <div class="md:mx-[-10px] xs:mx-0">
              <div class="lg:w-1/3 md:w-full md:mt-5 lg:mt-0 float-left px-[10px] relative">
                <h1 class="mt-0 mb-[10px] pt-[10px] font-AvenirNextLTPro text-[14px] leading-[20px] ">
                  <span dangerouslySetInnerHTML={{__html: subjects.title}}></span>
                </h1>
                <div class="">
                      ...
                      return (
                        <div role="listitem" class="">
                          <div class="pb-[10px] md:inline-block md:pr-[10px] lg:pr-0">
                            <a href={subject.href} class="cursor-pointer bg-[#475769] rounded-2xl py-[4px] px-[16px] max-w-full inline-block hover:bg-[#f26f21]"
                            style={{
                              transition: 'background-color .3s'
                            }}>
                              <div class="font-Gravity text-[12px] leading-[16px]">
                                <span dangerouslySetInnerHTML={{__html: subject.text}}></span>
                              </div>
                            </a>
                          </div>
                        </div>
                      ...
                      return (
                        <div role="listitem">
                          <div class="py-0 lg:px-[10px] md:px-0">
                            <a href={page.href} class="w-full border-b-[1px] border-b-solid border-b-[#eaeaea] 
                            ...
                            style={{
                              ...
                              <h3 class="py-[4px] font-AvenirNextLTPro text-[16px] leading-[18px] cursor-pointer my-0 ">
