...
function BannerDigitalTransformation(
    ...
    return (
        <div
            class="container-fluid grid relative lg:h-[640px] bg-[#585858]"
        >
            ...
            <div class="lg:w-[1120px] md:w-full h-full block mx-auto z-[2]">
                <div class="md:py-[60px] xs:py-[30px] lg:w-7/12 md:w-full xs:w-11/12 xs:m-auto md:m-0 md:px-5 lg:px-0 md:leading-[62px] xs:leading-[42px] text-[#fefefe]">
                    { image ? <img class="w-[152px] h-[54px] xs:hidden lg:block" src={image.source} alt={image.alt} /> : <></> }

                    <div class="lg:my-9 md:my-3 lg:mb-[72px] md:mb-[40px] xs:mb-[35px]">
                        <h1 class="lg:text-[58px] md:text-[52px] xs:text-[32px] font-AvenirNextLTPro">{ title }</h1>
                    </div>

                    <a href={ button.href } class="rounded bg-[#f26f21] font-bold uppercase px-[24px] xs:block md:inline-block xs:w-full md:w-auto cursor-pointer text-center">
                        { button.content }
                    </a>
