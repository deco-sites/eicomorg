...
function Courses(
  ...
  return (
    <>
      <div class="lg:py-[100px] md:py-[60px] md:px-5 lg:px-0 xs:px-[10px] xs:py-[40px] box-border"
        ...
        <div class="md:max-w-[1120px] xs:max-w-none mx-auto">
          ...
          <div class="md:mx-[-10px] xs:mx-0 items-stretch mt-10 lg:flex md:block">
            {courses.map((course, index) => {
              return (
                <div class={`justify-between py-[10px] lg:px-[15px] md:px-[5px] flex flex-row lg:w-1/3 md:w-full md:mx-auto md:left-auto md:right-auto float-left relative
                    ...
                    <div class="py-5 pl-5 pr-[30px] block">
                        ...
                        <div>
                          {course.paragraphWithIcon.map((paragraph) => {
                            ...
                            <div class="justify-start mb-5 flex items-start">
                              ...
                              <p class="">
                                <span  dangerouslySetInnerHTML={{ __html: paragraph.text }}></span>
                              </p>
                              </div>
                            </div>
                            )
                      ...
                      {course.text && (
                        <div class="mb-0 justify-start flex items-start">
                            <p class="font-Gravity text-[14px] leading-[18px] block text-left mb-[10px]" dangerouslySetInnerHTML={{ __html: course.text }}>
                            </p>
                        </div>
                      )}
                    </div>
