...
function BannerTheInstitute(
  { title, backgroundImage, button }: Props,
) {
      ...
      >
        <div class="box-border">
          ...
          <div class="z-10 h-[640px] max-w-[1120px] relative mx-auto">
            <div class="h-[640px] flex-col flex justify-between items-start pt-[60px] pb-[40px] relative right-[32px]">
              <div
              ...
              >
                <h1 class="my-5 font-AvenirNextLTPro text-[56px] leading-[68px] ml-0 w-[610px]">
...
export default BannerTheInstitute;
