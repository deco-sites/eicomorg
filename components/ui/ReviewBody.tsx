...
function ReviewBody(
  ...
  return (
    <>
      <div class="min-h-[80vh] border-[1px] border-white border-solid lg:py-[60px] xs:pt-[10px] xs:px-[10px] md:pt-5 md:px-5 md:pb-0 lg:px-0 lg:h-[2160px] md:h-[2360px] xs:h-[3700px]">
        <div class="z-auto max-w-[1120px] md:px-0 relative mx-auto">
          ...
          <div class="mb-[60px] py-0">
            <div role="list" class="">
              <div role="listitem">
                <a
                  href={article1.href}
                  class="cursor-pointer bg-white border-[1px] border-[#dfdfdf] border-solid rounded flex-row justify-between items-stretch flex relative max-w-full
          ...
          <div class="">
            <div role="list" class="md:mx-[-10px] xs:mx-[10px]">
              ...
              <div
                role="listitem"
                class="md:w-1/2 xs:w-full float-left md:px-[10px] xs:px-0 md:mb-0 xs:mx-0 relative"
              >
                <a
                  href={article2.href}
                  class="cursor-pointer bg-white border-[1px] border-[#dfdfdf] border-solid rounded flex-row justify-between items-stretch flex relative max-w-full
                  ...
                  <div class="rounded p-0 md:max-w-[400px] lg:max-w-full md:mx-auto">
                    ...
                    <div class="md:h-[250px] xs:h-auto xs:pb-0 flex-col flex justify-around py-[10px] px-[20px]">
                      <div class="mt-[10px] mb-0 font-Gravity text-[13px] leading-[16px] pr-[2px] text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article2.type }}
                          >
                          </span>
                        </p>
                      </div>
                      <h3 class="mt-[10px] font-AvenirNextLTPro text-[22px] leading-[28px] mb-0">
                        <span
                          dangerouslySetInnerHTML={{ __html: article2.title }}
                        >
                        </span>
                      </h3>
                      <div class="h-[60px] max-h-[60px] mt-0 mb-[10px] font-Gravity text-[15px] leading-[20px] overflow-hidden text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article2.text }}
                          >
                          </span>
                        </p>
                      </div>
                  ...
                  <div class="rounded p-0 md:max-w-[400px] lg:max-w-full md:mx-auto">
                    ...
                    <div class="md:h-[250px] xs:h-auto xs:pb-0 flex-col flex justify-around py-[10px] px-[20px]">
                      <div class="mt-[10px] mb-0 font-Gravity text-[13px] leading-[16px] pr-[2px] text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article3.type }}
                          >
                          </span>
                        </p>
                      </div>
                      <h3 class="mt-[10px] font-AvenirNextLTPro text-[22px] leading-[28px] mb-0">
                        <span
                          dangerouslySetInnerHTML={{ __html: article3.title }}
                        >
                        </span>
                      </h3>
                      <div class="h-[60px] max-h-[60px] mt-0 mb-[10px] font-Gravity text-[15px] leading-[20px] overflow-hidden text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article3.text }}
                          >
                          </span>
                        </p>
                      </div>
                ...
                >
                  <div class="bg-white border-[#dfdfdf] rounded pb-0">
                    <div class="items-stretch mx-[-10px] lg:flex xs:block">
                      <div class="self-end lg:w-[41.67%] xs:w-full xs:text-left md:text-center float-left lg:px-[10px] md:pl-0 md:pr-[10px] transition-all duration-200 relative">
                        <Image
                          src={article4.image.src}
                          alt={article4.image.alt}
                          height={454}
                          width={454}
                          loading="lazy"
                          class="mix-blend-multiply lg:max-w-full xs:max-w-[300px] md:mx-auto align-middle inline-block"
                  ...
                  <div class="rounded p-0 md:max-w-[400px] lg:max-w-full md:mx-auto">
                    ...
                    <div class="md:h-[250px] xs:h-auto xs:pb-0 flex-col flex justify-around py-[10px] px-[20px]">
                      <div class="mt-[10px] mb-0 font-Gravity text-[13px] leading-[16px] pr-[2px] text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article5.type }}
                          >
                          </span>
                        </p>
                      </div>
                      <h3 class="mt-[10px] font-AvenirNextLTPro text-[22px] leading-[28px] mb-0">
                        <span
                          dangerouslySetInnerHTML={{ __html: article5.title }}
                        >
                        </span>
                      </h3>
                      <div class="h-[60px] max-h-[60px] mt-0 mb-[10px] font-Gravity text-[15px] leading-[20px] overflow-hidden text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article5.text }}
                          >
                          </span>
                        </p>
                      </div>
              ...
              >
                ...
                >
                  <div class="rounded p-0 md:max-w-[400px] lg:max-w-full md:mx-auto">
                    <div
                      style={{
                        backgroundImage: `url(${article6.image.src})`,
                        backgroundRepeat: "no-repeat",
                        backgroundSize: "cover",
                    ...
                    <div class="md:h-[250px] xs:h-auto xs:pb-0 flex-col flex justify-around py-[10px] px-[20px]">
                      <div class="mt-[10px] mb-0 font-Gravity text-[13px] leading-[16px] pr-[2px] text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article6.type }}
                          >
                          </span>
                        </p>
                      </div>
                      <h3 class="mt-[10px] font-AvenirNextLTPro text-[22px] leading-[28px] mb-0">
                        <span
                          dangerouslySetInnerHTML={{ __html: article6.title }}
                        >
                        </span>
                      </h3>
                      <div class="h-[60px] max-h-[60px] mt-0 mb-[10px] font-Gravity text-[15px] leading-[20px] overflow-hidden text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article6.text }}
                          >
                          </span>
                        </p>
                      </div>
                  ...
                  <div class="rounded p-0 md:max-w-[400px] lg:max-w-full md:mx-auto">
                    ...
                    <div class="md:h-[250px] xs:h-auto xs:pb-0 flex-col flex justify-around py-[10px] px-[20px]">
                      <div class="mt-[10px] mb-0 font-Gravity text-[13px] leading-[16px] pr-[2px] text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article7.type }}
                          >
                          </span>
                        </p>
                      </div>
                      <h3 class="mt-[10px] font-AvenirNextLTPro text-[22px] leading-[28px] mb-0">
                        <span
                          dangerouslySetInnerHTML={{ __html: article7.title }}
                        >
                        </span>
                      </h3>
                      <div class="h-[60px] max-h-[60px] mt-0 mb-[10px] font-Gravity text-[15px] leading-[20px] overflow-hidden text-left">
                        <p>
                          <span
                            dangerouslySetInnerHTML={{ __html: article7.text }}
                          >
                          </span>
                        </p>
                      </div>
