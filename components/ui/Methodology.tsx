      ...
      >
        <div class="z-auto max-w-[1120px] pr-0 relative mx-auto">
          ...
          {cards.map((card) => {
            return (
              <div
                class={`md:w-[600px] xs:w-auto bg-[#fff] border-solid border-[1px] boder-[#dfdfdf] items-start md:mb-5 xs:mb-10 xs:mx-0 md:mx-auto md:pt-[40px] md:pr-[30px] md:pb-[30px] md:pl-0 md:flex xs:block xs:p-[10px]
					${isShown ? "animate-slide-left" : ""}`}
              >
                <div
                  class={`md:w-[80px] md:h-[80px] xs:w-[70px] xs:h-[70px] md:max-w-[80px] md:min-w-[80px] xs:max-w-[70px] xs:min-w-[70px] bg-white border-[1px] border-[#262628] rounded-[40px] justify-center items-center md:ml-[-40px] md:mr-[30px] md:my-0 xs:mt-[-35px] mx-auto mb-[20px] pt-0 flex shadow-[1px_1px_7px_rgba(0,0,0, 0.2)]
                ...
                <div class="">
                  ...
                  <p class="font-Gravity text-[16px] text-left leading-[1.6rem] mb-[10px]">
                    <span dangerouslySetInnerHTML={{ __html: card.mainText }}>
                    </span>
                  </p>
                  <h3 class="uppercase text-[18px] leading-[24px] mb-[10px] font-AvenirNextLTPro">
                    <span dangerouslySetInnerHTML={{ __html: card.boldText }}>
                    </span>
                  </h3>
                  {card.bottomImage && (
                    <Image
