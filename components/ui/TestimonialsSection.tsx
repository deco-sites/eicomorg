...
function TestimonialComponent({ testimonial, index }: { testimonial: Testimonial, index: number }) {
    return (
        <div
            class={`pt-[20px] pr-[30px] pb-[10px] pl-[30px] bg-[length:20px] bg-[20px_20px] bg-no-repeat bg-[url(/icons/Quotation-Marks-Left.svg)] relative border border-[#dfdfdf] col-span-1 md:mb-0 xs:mb-3 ${index % 2 ? 'row-span-1' : 'row-span-2'}`}
        >
            <div
            ...
            <div class="text-[#696969] block my-2">
                <span class="text-[14px] font-bold block">{ testimonial.person.name }</span>
